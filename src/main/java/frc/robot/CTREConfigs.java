...
public final class CTREConfigs {
    ...
    public CTREConfigs(){
        ...
        swerveAngleFXConfig.CurrentLimits.StatorCurrentLimitEnable = Constants.SwerveConstants.angleEnableCurrentLimit;
        swerveAngleFXConfig.CurrentLimits.StatorCurrentLimit = Constants.SwerveConstants.angleStatorCurrnetLimit;
        ...
        swerveDriveFXConfig.CurrentLimits.StatorCurrentLimitEnable = Constants.SwerveConstants.driveEnableCurrentLimit;
        swerveDriveFXConfig.CurrentLimits.StatorCurrentLimit = Constants.SwerveConstants.driveStatorCurrnetLimit;
